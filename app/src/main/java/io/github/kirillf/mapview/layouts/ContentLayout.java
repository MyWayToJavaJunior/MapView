package io.github.kirillf.mapview.layouts;
...
public class ContentLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                ContentLayout.LayoutParams lp = (ContentLayout.LayoutParams) child.getLayoutParams();
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof ContentLayout.LayoutParams;
    }
